...
def sample_batch():
    ...
    return {
        ...
        "cls": torch.tensor([5, 7, 2, 3, 1]),  # Class labels for each instance (valid for 8-class model)
...
def mock_args():
    ...
    # Return a dictionary instead of Mock to be compatible with Ultralytics config system
    return {
        'task': "segment",
        'half': False,
        'plots': False,
